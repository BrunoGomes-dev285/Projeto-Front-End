...
// Mapeamento das categorias para Emojis
const getEmoji = (cat) => {
  const emojis = {
    'Ônibus': '🚌',
    'Caminhão': '🚛',
            ...
            <div key={veiculo.id} className="col-12 col-md-6 col-lg-4 col-xl-3 mb-4">
              <div className={`card glass-card h-100 ${!veiculoAtivo ? 'offline-mode border-danger' : ''}`}>
                <div className="cenario">
                  ...
                  {/* Emoji do veículo renderizado na pista com tamanho ampliado */}
                  <a 
                    ...
                    style={{ animationPlayState: veiculoAtivo ? 'running' : 'paused', fontSize: '3rem', display: 'inline-block' }}
                  >
                    {getEmoji(categoria)}
                  </a>
                </div>
